...
So, to make up for it for future students. See this simulation that shows why running a chi-square test when you should have run an ANOVA is not a good idea.
